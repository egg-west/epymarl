...
class TaskEncoderMAC:
    ...
    def select_actions(
        ...
        #select actions for a specific time step
    ...
    def forward(self, ep_batch, t, task_embedding=None, test_mode=False, agent_embedding=None):
        ...
        agent_outs, self.hidden_states = self.agent(observations, agent_inputs, self.hidden_states, task_indices, task_embedding)
